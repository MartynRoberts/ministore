...
export default function ProductGallery({ images, title }: { images: string[]; title: string }) {
  ...
  return <div className={hasThumbnails ? "grid gap-4 sm:grid-cols-[72px_minmax(0,1fr)]" : "block"}>
    {hasThumbnails && <div className="order-2 -m-1 flex gap-2 overflow-x-auto p-1 pb-2 sm:order-1 sm:m-0 sm:flex-col sm:overflow-visible sm:p-0" role="group" aria-label="Product images">
